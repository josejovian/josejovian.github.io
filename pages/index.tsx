  ...
  return (
    <main className={clsx("w-full h-full py-16", "flex flex-col gap-16")}>
      ...
      <section className="flex flex-col gap-4">
        ...
        <p>
          I am an undergraduate computer science student, and an aspiring
          front-end developer. I am particularly interested in web development,
          especially React. I create personal projects to test out the things I
          have learnt.
        </p>
      ...
      <section>
        ...
        <PostGrid id="featured" contentType="projects" contents={projects} />
      </section>
    </main>
  );
};
